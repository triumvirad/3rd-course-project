...
func createDb(db *sql.DB) error {
	...
	// Инициализация регионов (разбил по странам для читаемости и безопасности)
	_, err = db.Exec(`
	...
	// УДАЛИЛ Молдавию и Украину полностью — больше их не будет вставлять
	log.Println("Регионы инициализированы без Молдавии и Украины")
