...
func createDb(db *sql.DB) error {
	...
	_, err = db.Exec(`
		...
		-- Молдавия (country_id = 8)
		('Аненій-Ной', 8), ('Бесарабяска', 8), ('Бричени', 8),
		('Кагул', 8), ('Кантемир', 8), ('Кэлэрашь', 8),
		('Кэушень', 8), ('Чимишлия', 8), ('Криулень', 8),
		('Дондюшень', 8), ('Дрокиа', 8), ('Дубэсарь', 8),
		('Единец', 8), ('Фэлешть', 8), ('Флорешть', 8),
		('Глодень', 8), ('Хынчешть', 8), ('Яловень', 8),
		('Леова', 8), ('Ниспорень', 8), ('Окница', 8),
		('Орхей', 8), ('Резина', 8), ('Рышкань', 8),
		('Сынжерей', 8), ('Сорока', 8), ('Стрэшень', 8),
		('Шолдэнешть', 8), ('Штефан-Водэ', 8), ('Тараклия', 8),
		('Теленешть', 8), ('Унгень', 8), ('Бэлць', 8),
		('Бендеры', 8), ('Кишинёв', 8), ('Гагаузия', 8),
		
		-- Украина (country_id = 9)
		('Винницкая область', 9), ('Волынская область', 9), ('Днепропетровская область', 9),
		('Донецкая область', 9), ('Житомирская область', 9), ('Закарпатская область', 9),
		('Запорожская область', 9), ('Ивано-Франковская область', 9), ('Киевская область', 9),
		('Кировоградская область', 9), ('Луганская область', 9), ('Львовская область', 9),
		('Николаевская область', 9), ('Одесская область', 9), ('Полтавская область', 9),
		('Ровенская область', 9), ('Сумская область', 9), ('Тернопольская область', 9),
		('Харьковская область', 9), ('Херсонская область', 9), ('Хмельницкая область', 9),
		('Черкасская область', 9), ('Черниговская область', 9), ('Черновицкая область', 9),
		('Автономная Республика Крым', 9), ('Киев', 9), ('Севастополь', 9)
		ON CONFLICT DO NOTHING;
	`)
	if err != nil {
		return err
